...
namespace Constant
{
	...
	static const std::string WHITE_NOISE_TEXTURE_PATH = "res/textures/Noise/grayWhiteNoise01.bmp";
	static const std::string ABSTRACT_NOISE_01_TEXTURE_PATH = "res/textures/Noise/abstract01.jpg";
