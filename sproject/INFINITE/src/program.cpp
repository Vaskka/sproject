...
//*********************************************************************************
//FUNCTION:
void CProgram::addShader(const std::string& vShaderName, EShaderType vShaderType)
{
...
//*********************************************************************************
//FUNCTION:
void CProgram::addShader(const std::vector<std::string>& vShaderNameSet, EShaderType vShaderType)
{
...
//*********************************************************************************
//FUNCTION:
void CProgram::setTextureUniformValue(const char *name, unsigned int n)
{
...
//*********************************************************************************
//FUNCTION:
void CProgram::setMat4UniformValue(const char *name, const glm::mat4 &mat)
{
	GLint key = glGetUniformLocation(m_ProgramID, name);
...
//*********************************************************************************
//FUNCTION:
void CProgram::setMat3UniformValue(const char *name, const glm::mat3 &mat)
{
	GLint key = glGetUniformLocation(m_ProgramID, name);
...
//*********************************************************************************
//FUNCTION:
void CProgram::setFloatUniformValue(const char *name, GLfloat v0)
{
	GLint key = glGetUniformLocation(m_ProgramID, name);
...
//*********************************************************************************
//FUNCTION:
void CProgram::setFloatUniformValue(const char *name, GLfloat v0, GLfloat v1)
{
	GLint key = glGetUniformLocation(m_ProgramID, name);
...
//*********************************************************************************
//FUNCTION:
void CProgram::setFloatUniformValue(const char *name, GLfloat v0, GLfloat v1, GLfloat v2)
{
	GLint key = glGetUniformLocation(m_ProgramID, name);
...
//*********************************************************************************
//FUNCTION:
void CProgram::setFloatUniformValue(const char *name, GLfloat v0, GLfloat v1, GLfloat v2, GLfloat v3)
{
	GLint key = glGetUniformLocation(m_ProgramID, name);
...
//*********************************************************************************
//FUNCTION:
void CProgram::setIntUniformValue(const char *name, GLint v0)
{
	GLint key = glGetUniformLocation(m_ProgramID, name);
...
//*********************************************************************************
//FUNCTION:
void CProgram::setIntUniformValue(const char *name, GLint v0, GLint v1)
{
	GLint key = glGetUniformLocation(m_ProgramID, name);
...
//*********************************************************************************
//FUNCTION:
void CProgram::setIntUniformValue(const char *name, GLint v0, GLint v1, GLint v2)
{
	GLint key = glGetUniformLocation(m_ProgramID, name);
...
//*********************************************************************************
//FUNCTION:
void CProgram::setIntUniformValue(const char *name, GLint v0, GLint v1, GLint v2, GLint v3)
{
	GLint key = glGetUniformLocation(m_ProgramID, name);
...
//*********************************************************************************
//FUNCTION:
std::string CProgram::__readShaderFile(const std::string& vFileName)
{
...
//*********************************************************************************
//FUNCTION:
void CProgram::__compileShader(GLuint& vShader)
{
...
//*********************************************************************************
//FUNCTION:
void CProgram::__linkProgram(GLuint& vProgram)
{
