...
namespace util
{
	...
	GLuint loadTexture(const char *vPath, GLint vFilterMode = Default::TEXTURE_FILTER_MODE, GLint vWrapMode = Default::TEXTURE_WRAP_MODE, GLenum vFormat = Default::TEXTURE_FILTER_MODE, bool vVerticallyFlip = Default::TEXTURE_IS_VFLIP, bool vGenerateMipMap = Default::TEXTURE_IS_MIPMAP);
